const pokeTypes = [
  ...
  { type: 'Grass', color: '#9BCB50', src: '/icons/grass.svg' },
  { type: 'Lightning', color: '#EDD435', src: '/icons/electric.svg' },
  { type: 'Metal', color: '#9DB7B7', src: '/icons/steel.svg' },
  { type: 'Psychic', color: '#F365B8', src: '/icons/psychic.svg' },
  { type: 'Water', color: '#4592C3', src: '/icons/water.svg' },
];
